...
public class HomeController : Controller
{
    ...
    public IActionResult GeneralSearch(string searchType,string searchString)
    {
        ...
        {
            return RedirectToAction("Search", "Project", new {area = "ProjectManagement", searchString = searchString });
        }
        else if (searchType == "tasks")
        {
            return RedirectToAction("Search", "ProjectTask", new { area = "ProjectManagement", searchString = searchString });
        }
